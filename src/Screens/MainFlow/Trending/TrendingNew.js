...
import { View, Text, StyleSheet, Slider, TextInput, ScrollView, TouchableOpacity, FlatList, Image, findNodeHandle, Modal, Dimensions, ImageBackground, AsyncStorage } from 'react-native';
...
const Trending = ({navigation}) => {
    ...
    const loadData = async () => {
        ...
        try
        {
            ...
            await fetch('http://192.168.0.8:8000/display-trending/', {
                method: 'POST',
                headers: {
