...
const OffersSimple = ({navigation}) => {
        ...
        const loadData = async () => {
            ...
            try
            {
                ...
                await fetch('http://trevi-server.us-west-2.elasticbeanstalk.com/display-offers/', {
                    method: 'POST',
                    headers: {
        ...
        return (
            <View style={styles.container}>
                    ...
                    <Button title='Back to Trending'
                            onPress={() => navigation.navigate('TrendingSimple')}/>
